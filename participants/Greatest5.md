...
## (0)Greatest5 and https://filecoinproject.slack.com/team/U01AXUTV6JZ
...
## (12) Have users or not：Have users.
Plan of how to gain users：we will hold conferences on distributed storage; exchange resources with public clouds (such as Aliyun, Amazon cloud and so on); also provide low - cost storage space, retrieval traffic in a period of time.

## (13) What challenges do you anticipate with this project?
## (13)Adjustments you expected in this project：Improve the accuracy and speed of retrieval
What kind of help do you need from official website：It is hoped that technical solutions can be provided to improve the accuracy and speed of retrieval.
